...
knit: (function(input_file, encoding) {
  out_dir <- 'R markdown';
  rmarkdown::render(input_file, encoding = encoding, output_file = file.path(dirname(input_file), out_dir, 'index.html')) #knit to html into the file 'R markdown/index.html'
  })
---
<style type="text/css">
.main-container {
